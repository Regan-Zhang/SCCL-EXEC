...
def get_args(argv):
    ...
    # Dataset
    parser.add_argument('--datapath', type=str, default='/home/derek/zhxRegan/textdatasets/Agnews')
    parser.add_argument('--dataname', type=str, default='agnewsdataraw_word_deletion_20', help="")
