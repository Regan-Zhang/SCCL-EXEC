...
def augment_files(datadir="./", targetdir="./", dataset="wiki1m_unique", aug_p=0.1, augtype="trans_subst"):
    ...
    if augtype == "word_deletion":
        ...
        randomchar_augment(DataSource, DataTarget, textcol="text", aug_p=aug_p, augstage="init")
    else:
...
if __name__ == '__main__':
    ...
    datadir = "/home/derek/zhxRegan/textdatasets"
    targetdir = "/home/derek/zhxRegan/textdatasets/Agnews"
    augment_files(datadir=datadir, targetdir=targetdir, dataset="agnewsdataraw", aug_p=0.2, augtype="charswap")
